...
train_csv_path
num_shards (1)
generate_train_validation_splits true "SIEMPRE "
validation_split_size "OBLIGATORIO"
seed 180298
"""
...
def _get_clean_train_image_files_and_labels(csv_path, image_dir):
  ...
  """
  # Load the content of the CSV file (type_galaxy_id/label -> images).
...
def _build_train_tfrecord_dataset(clean_csv_path,
                                  image_dir,
